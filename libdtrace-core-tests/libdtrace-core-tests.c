...
ATF_TC_WITHOUT_HEAD(DIF_OP_BGE);
ATF_TC_BODY(DIF_OP_BGE, tc)
{
	/*
	...
	dtapi_op_cmp(dtapi_conf, 7, 8, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_bge(dtapi_conf, 0xD06E, &err);
	...
	dtapi_op_cmp(dtapi_conf, 7, 7, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_bge(dtapi_conf, 0, &err);
...
ATF_TC_WITHOUT_HEAD(DIF_OP_BGEU);
ATF_TC_BODY(DIF_OP_BGEU, tc)
{
	/*
	...
	dtapi_op_cmp(dtapi_conf, 7, 8, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_bgeu(dtapi_conf, 0xD06E, &err);
	...
	dtapi_op_cmp(dtapi_conf, 7, 7, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_bgeu(dtapi_conf, 0, &err);
...
ATF_TC_WITHOUT_HEAD(DIF_OP_BL);
ATF_TC_BODY(DIF_OP_BL, tc)
{
	/*
	...
	dtapi_op_cmp(dtapi_conf, 7, 8, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_bl(dtapi_conf, 0xD06E, &err);
	...
	dtapi_op_cmp(dtapi_conf, 8, 7, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_bl(dtapi_conf, 0, &err);
...
ATF_TC_WITHOUT_HEAD(DIF_OP_BLU);
ATF_TC_BODY(DIF_OP_BLU, tc)
{
	/*
	...
	dtapi_op_cmp(dtapi_conf, 7, 8, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_blu(dtapi_conf, 0xD06E, &err);
	...
	dtapi_op_cmp(dtapi_conf, 8, 7, &err);
	ATF_CHECK_EQ(0, err);
	pc = dtapi_op_blu(dtapi_conf, 0, &err);
