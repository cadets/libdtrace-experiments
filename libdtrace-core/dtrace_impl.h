 ...
 * Copyright 2017 Domagoj Stolfa. All rights reserved.
...
#ifdef _DTRACE_TESTS
extern int dtrace_emul_instruction(dif_instr_t, dtrace_estate_t *, dtrace_mstate_t *,
    dtrace_vstate_t *, dtrace_state_t *);
extern dtrace_probe_t *dtrace_getprobe(dtrace_id_t);
extern int dtrace_difo_validate(dtrace_difo_t *, dtrace_vstate_t *, uint_t, cred_t *);
#endif
